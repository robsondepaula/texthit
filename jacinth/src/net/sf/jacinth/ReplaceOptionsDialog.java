...
public class ReplaceOptionsDialog extends JDialog {
    ...
    public static int showDialog(Component comp, String text) {
        ReplaceOptionsDialog dlg = getNewReplaceDialog(comp, text);
    ...
    /**
     * This function allows to get a new replace dialog by giving the
     ...
     * @return
     */
    static public ReplaceOptionsDialog getNewReplaceDialog(Component component, String text) {
        while (component != null && !(component instanceof Frame) && !(component instanceof Dialog))
            component = component.getParent();

        if (component == null)
            return new ReplaceOptionsDialog((Frame)null, text);
        else if (component instanceof Dialog)
            return new ReplaceOptionsDialog((Dialog)component, text);
        else
            return new ReplaceOptionsDialog((Frame)component, text);
    }
    ...
    private ReplaceOptionsDialog(Frame frame, String text) {
    ...
    private ReplaceOptionsDialog(Dialog dialog, String text) {
        super(dialog, Local.getString(REPLACE), true);
        try {
            textLabel.setText(text);
            jbInit();
            pack();
    ...
    void jbInit() throws Exception {
        ...
        textLabel.setIcon(new ImageIcon(net.sf.jacinth.HTMLEditor.class.getResource("resources/icons/findbig.png"))) ;
