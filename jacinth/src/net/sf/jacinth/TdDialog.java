...
public class TdDialog extends JacinthDialog {
    
    final static String TABLE_PROPERTIES = "Table properties";
  ...
  public JTextField tdBgcolorField = new ColorField();
  ...
  public JTextField trBgcolorField = new ColorField();
  ...
  /**
   * This function allows to get a new table properties dialog by giving the
   ...
   * @return
   */
  static public TdDialog getNewTDDialog(Component component) {
      ...
      if (component == null)
          dialog = new TdDialog((Frame)null);
      else if (component instanceof Dialog)
          dialog = new TdDialog((Dialog)component);
      else
          dialog = new TdDialog((Frame)component);
  ...
  private TdDialog(Frame frame) {
    super(frame, Local.getString(TABLE_PROPERTIES), TableDialog.icon, true);
    try {
      jbInit();
      pack();
    }
  ...
  private TdDialog(Dialog dialog) {
      super(dialog, Local.getString(TABLE_PROPERTIES), TableDialog.icon, true);
      try {
        jbInit();
        pack();
      }
  ...
  void jbInit() throws Exception {
    ...
    tdBgcolorB.setIcon(new ImageIcon(net.sf.jacinth.ImageDialog.class.getResource("resources/icons/color.png")));
    ...
    trBgcolorB.setIcon(new ImageIcon(net.sf.jacinth.ImageDialog.class.getResource("resources/icons/color.png")));
    ...
    bgColorB.setIcon(new ImageIcon(net.sf.jacinth.ImageDialog.class.getResource("resources/icons/color.png")));
